<div class="flex flex-row items-center gap-3">
    ...
    <div x-data="{ open: false }">
        ...
        <div x-show="open" @click.away="open = false"
            class="origin-top-right absolute right-1 mt-5 w-30 mr-5 rounded-md shadow-lg z-10 bg-gray-600 text-gray-100"
            style="display: none;">
            <div class="p-2">
                <ul>
                    <li class="p-2 hover:bg-gray-200 hover:text-gray-700 transition duration-300 cursor-pointer"
                        wire:click="$set('selectedIsland', '')">All Islands</li>
